...
UART device simulator in C++ modeling framing, baud rate timing, simple parity/CRC, and configurable noise/error injection for host-side testing of serial protocols.
