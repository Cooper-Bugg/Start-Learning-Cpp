...
Small collection of portable helpers that use inline assembly where necessary for timing, atomic primitives, or CPU feature detection (CPUID). Emphasis on safe usage and documented fallbacks.
