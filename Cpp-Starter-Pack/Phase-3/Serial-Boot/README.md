...
Simple bootloader and serial firmware update demonstration focused on safe image transfer, validation, and rollback protection. Contains both host-side updater logic and a minimal target-side stub for testing.
