...
Small collection of bare-metal-style driver examples (GPIO, UART, SPI, I2C) with host-side test stubs. Structured as educational pieces to learn hardware abstraction without requiring physical devices.
